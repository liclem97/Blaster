...
void ABlasterPlayerController::HighPingWarnig()
{
	BlasterHUD = BlasterHUD == nullptr ? Cast<ABlasterHUD>(GetHUD()) : BlasterHUD;
	bool bHUDValid = BlasterHUD &&
		BlasterHUD->CharacterOverlay &&
...
void ABlasterPlayerController::StopHighPingWarnig()
{
	BlasterHUD = BlasterHUD == nullptr ? Cast<ABlasterHUD>(GetHUD()) : BlasterHUD;
	bool bHUDValid = BlasterHUD &&
		BlasterHUD->CharacterOverlay &&
...
void ABlasterPlayerController::SetHUDMessage(FString Message)
{
	BlasterHUD = BlasterHUD == nullptr ? Cast<ABlasterHUD>(GetHUD()) : BlasterHUD;
	bool bHUDValid = BlasterHUD &&
		BlasterHUD->CharacterOverlay &&
		BlasterHUD->CharacterOverlay->MessageText;
	if (bHUDValid)
	{
		FString NewMessageText = Message;
		BlasterHUD->CharacterOverlay->MessageText->SetText(FText::FromString(NewMessageText));
	}
}
